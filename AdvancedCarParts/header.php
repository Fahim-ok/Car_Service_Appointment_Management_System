...
<body>
  ...
  ?>
  <nav class="navbar navbar-inverse navbar-fixed-top " style="background-color: #000000; text-transform: uppercase; border-bottom: 1px solid white;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img src="img/car.jpg" alt="" style="width: 50px;height: 50px;"></a>
